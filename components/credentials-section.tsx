              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4">
                {credentialsInfo.certifications.map((cert, index) => (
                  <a
                    ...
                    className="flex items-start bg-zinc-800/30 p-2 sm:p-3 rounded-lg hover:bg-zinc-800/50 transition-colors cursor-pointer group"
                  >
                    {cert.logo && (
                    ...
                    <div className="flex-1">
                      <div className="flex items-start justify-between">
                        <div>
                          <h5 className="text-sm font-medium group-hover:text-cyan-400 transition-colors">
                            {cert.name}
                          </h5>
                        ...
                        <ExternalLink className="w-3 h-3 text-zinc-500 group-hover:text-cyan-400 transition-colors flex-shrink-0 ml-2" />
                      </div>
                    </div>
                  </a>
                ))}
